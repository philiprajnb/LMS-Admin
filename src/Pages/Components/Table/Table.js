      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableHead>
          <TableRow className="text-nowrap">
            ...
            <StyledTableCell align="center">Assigned to Agent</StyledTableCell>
            <StyledTableCell align="center" >Additional Information</StyledTableCell>
        </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
           ...
           <StyledTableRow key={lead._id} className="text-nowrap">
              <StyledTableCell component="th" className={`cursor-pointer ${styles.flipper}`} scope="row" onClick={()=>{props.openActivityBox(lead)}}>
                {lead.processID}
              </StyledTableCell>
              ...
              <StyledTableCell align="center">{lead.processData['WF Description']}</StyledTableCell>
              <StyledTableCell align="center">{lead.processData['AssignedAgentName']}</StyledTableCell>
              <StyledTableCell align="center">
                  <i className={"fa fa-info-circle text-primary cursor-pointer"} onClick={()=>{props.openAdditionalInfo(lead)}}></i>
              </StyledTableCell>
            </StyledTableRow>
          ))}
